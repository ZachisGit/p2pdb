...
use libp2p::{
    autonat, core::Multiaddr, dcutr, identify, identity::{Keypair, PeerId, PublicKey}, kad::{self, store::MemoryStore}, mdns::{tokio::Behaviour as Mdns, Event as MdnsEvent}, multiaddr::Protocol, relay, rendezvous, swarm::{
...
impl<'a> DiscoveryConfig<'a> {
    ...
    pub fn new(keypair: Keypair, local_public_key: PublicKey, network_name: &'a str, relay_behaviour: relay::client::Behaviour) -> Self {
        DiscoveryConfig {
                    ...
                    match &ev {
                        ...
                        DerivedDiscoveryBehaviourEvent::RelayClient(ev) => match &ev {
                            ...
                            relay::client::Event::OutboundCircuitEstablished { relay_peer_id, limit } => {
                                println!("RelayClient OutboundCircuitEstablished - {:?} {:?}",relay_peer_id.clone(),limit.clone());
                            },
